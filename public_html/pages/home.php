...
<html lang="pt-br">
    ...
    <body onLoad="fecha_loader()">
                    ...
                    <ul>
                        ...
                        while ($voResultadoBanner = mysqli_fetch_object($vrsExecutaBanner)) {
                            ...
                            <li data-transition="random">
                                <img src="<?php echo URL . "wdadmin/uploads/banners_slideshow/" . $voResultadoBanner->imagem ?>" title="<?php echo $voResultadoBanner->titulo ?>" alt="<?php echo $voResultadoBanner->titulo ?>" data-bgposition="center center" data-no-retina>
                                ...
                                <div class="tp-caption tp-resizeme text-ffb922 font-rubik font-weight-500 wellcome make text-center"
                                     ...
                                     data-splitin="none" 
                                     data-splitout="none" 
                                     data-responsive_offset="on"><?php echo $voResultadoBanner->descricao ?></div>
                                <div class="tp-caption tp-resizeme font-rubik font-weight-700 text-white style1 text-center"
                                     ...
                                     data-fontsize="['95','60','40','28']"
                                     data-lineheight="['119','80','45','43']"
                                     data-width="full"
                                     data-height="none"
                                     data-whitespace="normal"
                                     data-transform_idle="o:1;"
                                     ...
                                     data-splitin="none" 
                                     data-splitout="none" 
                                     data-responsive_offset="on"><?php echo $voResultadoBanner->titulo ?></div>
                                ...
                                <div class="tp-caption text-center"
                                    ...
                                    <div class="button-btn elm-btn slider1 hvr-shutter-out-vertical">
                                        <a href="<?php echo $voResultadoBanner->link ?>">Ver Mais
        ...
        <div class="main-homepage4">

            <?php // SOLUÇÕES ?>
            <section class="flat-servicess p-b-80">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        while ($voResultadoSolucoes = mysqli_fetch_object($vrsExecutaSolucoes)) {
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="content-servicess" style="background-image: url(wdadmin/uploads/servicos/<?php echo $voResultadoSolucoes->imagem ?>);">
                                    <div class="hover-new">
                                        <div class="nhap servico">
                                            <i class="<?php echo $voResultadoSolucoes->icone ?>"></i>
                                            <h2><a href="<?php echo URL . "solucoes/" . $voResultadoSolucoes->url_amigavel ?>"><?php echo $voResultadoSolucoes->titulo ?></a></h2>
                                        </div>
                                        <div class="btn-bt">
                                            <a href="<?php echo URL . "solucoes/" . $voResultadoSolucoes->url_amigavel ?>"><i class="fas fa-arrow-right" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <?php // INSTITUCIONAL ?>
            <section class="flat-about-awrds section-quem-somos">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="content-about-awrds">
                                <?php
            ...
            <?php /* PARCEIROS
              <div class="flat-sponsors">
              <div class="container">
              <div class="row">
              <div class="col-lg-12">
              <div class="wrap-logo">
              <h5>Parceiros</h5>
              <h1>Veja abaixo nossos contribuidores</h1>
              <div class="flat-carousel-box data-effect clearfix" data-gap="30" data-column="6" data-column2="1" data-column3="1" data-dots="false" data-nav="true"  data-auto="false">
              <div class="owl-carousel">
              <?php
              $vsSqlParceiros = "SELECT titulo, imagem FROM informacoes WHERE id_conteudo_personalizado = 3 ORDER BY titulo";
              ...
              ?>
              <div class="image">
              <a><img src="<?php echo URL . "wdadmin/uploads/informacoes/" . $voResultadoParceiros->imagem ?>" title="<?php echo $voResultadoParceiros->titulo ?>" alt="<?php echo $voResultadoParceiros->titulo ?>"></a>
              </div>
              <?php
              }
              ?>
              ...
              <?php /* CASES
              <section class="flat-our-blog-style2">
              <div class="container">
              <div class="row">
              <div class="col-lg-12">
              <div class="title-section yewlow">
              <p>Cases</p>
              <div class="content-inner clearfix">
              <div class="wrap-contentt">
              <h2>Veja abaixo alguns de nossos cases</h2>
              </div>
              <div class="wrap-btn">
              <a href="<?php echo URL . "casos-de-sucesso" ?>" class="flat-button-arrow btn-ce1b28">Ver Todos</a>
              </div>
              </div>
              </div>
              </div>
              <?php
              $vsSqlCases = "SELECT titulo, imagem1, descricao FROM galeria_imagem WHERE id_galeria_grupo = 2 ORDER BY id_galeria_imagem DESC LIMIT 3";
              $vrsExecutaCases = mysqli_query($Conexao, $vsSqlCases) or die("Erro ao efetuar a operação no banco de dados! <br> Arquivo:" . __FILE__ . "<br>Linha:" . __LINE__ . "<br>Erro:" . mysqli_error($Conexao));
              while ($voResultadoCases = mysqli_fetch_object($vrsExecutaCases)) {
              ?>
              <div class="col-sm-4">
              <div class="post">
              <div class="featured-post">
              <img src="<?php echo URL . "wdadmin/uploads/galeria_imagens/" . $voResultadoCases->imagem1 ?>" title="<?php echo $voResultadoCases->titulo ?>" alt="<?php echo $voResultadoCases->titulo ?>">
              </div>
              <div class="content-post">
              <h2><?php echo $voResultadoCases->titulo ?></h2>
              <p><?php echo $voResultadoCases->descricao ?></p>
              </div>
              </div>
              </div>
              <?php
            ...
            <?php // CHAMADA ?>
            <section class="flat-call-to-action-style2">
                <div class="wrap-call-to-action style2 clearfix flat-call-to-action-style2">
                    <div class="container">
                        <div class="text-call-to-action style2">
                            <h5>FICOU INTERESSADO?</h5>
                            <h2>Entre em Contato Conosco</h2>
                        </div>
                        <div class="wrap-btn">
                            <a href="<?php echo URL . "contato" ?>" class="flat-button-arrow">Clique Aqui</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <?php /* DEPOIMENTOS
              <section class="flat-features-2 flat-testimonials style3">
              <div class="container">
              <div class="row">
              <div class="col-lg-12">
              <div class="title-case">
              <h5>Depoimentos</h5>
              <h1>Veja abaixo o que nossos clientes disseram</h1>
              </div>
              </div>
              <div class="col-lg-12">
              <div class="flat-carousel-box data-effect clearfix" data-gap="30" data-column="3" data-column2="2" data-column3="1" data-dots="false" data-nav="true"  data-auto="false">
              <div class="owl-carousel">
              <?php
              $vsSqlDepoimentos = "SELECT nome, texto, imagem FROM depoimentos ORDER BY id_depoimentos DESC";
              ...
              <h2><?php echo $voResultadoDepoimentos->nome ?></h2>
              <a><i class="fa fa-quote-left" aria-hidden="true"></i></a>
              ...
              <div class="content-inner clearfix">
              <div class="wrap-contentt">
              <h2>Veja Abaixo nossos posts mais recentes</h2>
              </div>

              <div class="wrap-btn">
              <a href="<?php echo URL . "artigos" ?>" class="flat-button-arrow btn-ce1b28">Ver Todos</a>
              </div>
              </div>
              </div>
              </div>
              ...
              blog_postagem
              WHERE
              id_blog_subcategorias = 1
              ORDER BY id_blog_postagem DESC
              LIMIT 3
              ";
              $vrsExecutaArtigos = mysqli_query($Conexao, $vsSqlArtigos) or die("Erro ao efetuar a operação no banco de dados! <br> Arquivo:" . __FILE__ . "<br>Linha:" . __LINE__ . "<br>Erro:" . mysqli_error($Conexao));
              $i = 1;
              while ($voResultadoArtigos = mysqli_fetch_object($vrsExecutaArtigos)) {
              if ($i % 3 == 0) {
              ?>
              <div class=" col-md-3 col-sm-6">
              <article class="post">
              <div class="featured-post">
              <img src="<?php echo URL . "wdadmin/uploads/blog_postagens/" . $voResultadoArtigos->imagem ?>" title="<?php echo $voResultadoArtigos->titulo ?>" alt="<?php echo $voResultadoArtigos->titulo ?>">
              </div>
              <div class="content-post">
              <ul>
              <li><a><i class="fas fa-calendar-alt" aria-hidden="true"></i> <?php echo $voResultadoArtigos->data_publicacao ?></a></li>
              </ul>
              <h5><a href="<?php echo URL . "artigos/" . $voResultadoArtigos->url_amigavel ?>"><?php echo $voResultadoArtigos->titulo ?></a></h5>
              <p><?php echo substr(strip_tags(trim($voResultadoArtigos->texto)), 0, strrpos(substr(strip_tags(trim($voResultadoArtigos->texto)), 0, 70), ' ')) . '...'; ?></p>
              </div>
              </article>
              </div>
              <?php
              ...
              <article class="post">
              <div class="featured-post style2">
              <img src="<?php echo URL . "wdadmin/uploads/blog_postagens/" . $voResultadoArtigos->imagem ?>" title="<?php echo $voResultadoArtigos->titulo ?>" alt="<?php echo $voResultadoArtigos->titulo ?>">
              </div>
              <div class="content-post style1">
              <h3><a href="<?php echo URL . "artigos/" . $voResultadoArtigos->url_amigavel ?>"><?php echo $voResultadoArtigos->titulo ?></a></h3>
              <p class="texto-artigo"><?php echo substr(strip_tags(trim($voResultadoArtigos->texto)), 0, strrpos(substr(strip_tags(trim($voResultadoArtigos->texto)), 0, 70), ' ')) . '...'; ?></p>
              <div class="meta">
              <ul>
              <li>
              <p class="date"><i class="fas fa-calendar-alt" aria-hidden="true"></i> <?php echo $voResultadoArtigos->data_publicacao ?></p>
              </li>
              </ul>
              </div>
              </div>
